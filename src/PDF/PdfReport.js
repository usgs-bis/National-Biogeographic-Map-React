    ...
    generateReport(name, type, map, charts) {
        ...
        Promise.all(charts.flat()).then(contents => {
            ...
            docDefinition.content.push({
                text: [
                    {
                        text: `This summary report was generated on ${new Date().toUTCString()} using USGS National Biogeographic Map analytics and data assets. The analysis packages and data sources used for this synthesis are documented below. To recreate the synthesis with current data and analytical methods, click `
                    },
