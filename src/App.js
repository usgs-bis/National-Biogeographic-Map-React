...
class App extends React.Component {
    ...
    layerTransitionFade(layer, layer2, targetOpacity) {
        ...
        if (recurse) {
            setTimeout(() => { this.layerTransitionFade(layer, layer2, targetOpacity) }, 200)
        }
        ...
        //   we should only get here if we're done with the recursion, so something is messed up if opacity is this low
